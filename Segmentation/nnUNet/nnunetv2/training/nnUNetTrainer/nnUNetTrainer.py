...
from nnunetv2.training.loss.iou import IoULoss
    ...
    def _build_loss(self):
        if self.label_manager.has_regions:
            ...
            loss = DC_and_CE_loss({'batch_dice': self.configuration_manager.batch_dice,
                                  ...
                                  ignore_label=self.label_manager.ignore_label, dice_class=MemoryEfficientSoftDiceLoss, iou_loss=IoULoss)
